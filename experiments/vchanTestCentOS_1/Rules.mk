...
-include $(EXP_ROOT)/config/Tools.mk
include $(EXP_ROOT)/Config.mk

export _INSTALL := $(INSTALL)
INSTALL = $(EXP_ROOT)/tools/cross-install

XEN_INCLUDE        = $(EXP_ROOT)/tools/include
XEN_LIBXC          = $(EXP_ROOT)/tools/libxc
XEN_XENLIGHT       = $(EXP_ROOT)/tools/libxl
XEN_XENSTORE       = $(EXP_ROOT)/tools/xenstore
XEN_LIBXENSTAT     = $(EXP_ROOT)/tools/xenstat/libxenstat/src
XEN_BLKTAP2        = $(EXP_ROOT)/tools/blktap2
XEN_LIBVCHAN       = $(EXP_ROOT)/tools/libvchan
...
INSTALL_PYTHON_PROG = \
	$(EXP_ROOT)/tools/python/install-wrap "$(PYTHON_PATH)" $(INSTALL_PROG)
